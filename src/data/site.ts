...
export const projects: Project[] = [
  ...
  {
    id: 'wheat-disease-yolo',
    name: 'Wheat Leaf Disease Detection with YOLOv8',
    category: 'research',
    featured: false,
    summary: 'Real-time wheat disease detection using YOLOv8 on field imagery for early intervention.',
    highlights: ['Multi-class disease labels', 'Field-ready detection latency'],
    tech: ['YOLOv8', 'PyTorch', 'OpenCV'],
    image: media('projects', 'project-13', 'leaf-segmentation.png'),
  },
  {
    id: 'maize-deficiency-cnn',
    name: 'Maize Nutrient Deficiency Classification',
    category: 'research',
    featured: false,
    summary: 'CNN-based nutrient deficiency classification for maize leaves under controlled lighting.',
    highlights: ['Class-balanced training', 'Interpretability with confusion analysis'],
    tech: ['CNN', 'TensorFlow', 'Keras'],
    image: media('projects', 'project-14', 'fig5-deficiency-training-dataset.png'),
  },
  {
    id: 'tomato-ripeness-cv',
    name: 'Tomato Ripeness Estimation',
    category: 'research',
    featured: false,
    summary: 'Computer vision pipeline for grading tomato ripeness stages from RGB images.',
    highlights: ['Color-space feature fusion', 'Edge deployment prototype'],
    tech: ['OpenCV', 'Scikit-learn', 'Python'],
    image: media('projects', 'project-7', 'app-1.png'),
  },
  {
    id: 'greenhouse-anomaly-detection',
    name: 'Greenhouse Sensor Anomaly Detection',
    category: 'industry',
    featured: false,
    summary: 'Time-series anomaly detection over greenhouse telemetry for early fault alerts.',
    highlights: ['Streaming alert pipeline', 'Low false-positive thresholding'],
    tech: ['Python', 'LSTM', 'Pandas'],
    image: media('projects', 'project-13', 'incubator-deployment.png'),
  },
  {
    id: 'drone-crop-counting',
    name: 'Drone Crop Counting and Stand Estimation',
    category: 'research',
    featured: false,
    summary: 'Aerial CV pipeline for crop stand counting and emergence estimation.',
    highlights: ['Orthomosaic preprocessing', 'Counting accuracy benchmarking'],
    tech: ['YOLO', 'OpenCV', 'GeoPandas'],
    image: media('projects', 'project-7', 'Deployment-1.png'),
  },
  {
    id: 'weed-seg-unet',
    name: 'Weed Segmentation with U-Net',
    category: 'research',
    featured: false,
    summary: 'Pixel-wise weed segmentation baseline with U-Net for precision spraying systems.',
    highlights: ['Dice-focused optimization', 'Small-object refinement'],
    tech: ['U-Net', 'PyTorch', 'Albumentations'],
    image: media('projects', 'project-10', 'segmentation-comparison.png'),
  },
  {
    id: 'orchard-fruit-detection',
    name: 'Orchard Fruit Detection Pipeline',
    category: 'research',
    featured: false,
    summary: 'Object detection pipeline for orchard fruit counting and harvest planning support.',
    highlights: ['Occlusion-aware training', 'Per-tree count aggregation'],
    tech: ['YOLOv5', 'PyTorch', 'NumPy'],
    image: media('projects', 'project-13', 'cover.png'),
  },
  {
    id: 'multispectral-plant-health',
    name: 'Multispectral Plant Health Indexing',
    category: 'research',
    featured: false,
    summary: 'Plant stress estimation from multispectral cues and lightweight ML regressors.',
    highlights: ['Vegetation index fusion', 'Cross-plot generalization checks'],
    tech: ['Scikit-learn', 'Python', 'OpenCV'],
    image: media('projects', 'project-7', 'FCN For Segmentation.png'),
  },
  {
    id: 'seed-quality-classification',
    name: 'Seed Quality Classification',
    category: 'research',
    featured: false,
    summary: 'Image-based seed quality grading for sorting pipelines in agri-processing.',
    highlights: ['Texture-feature modeling', 'Class imbalance handling'],
    tech: ['CNN', 'TensorFlow', 'OpenCV'],
    image: media('projects', 'project-6', 'cover.png'),
  },
  {
    id: 'irrigation-demand-forecasting',
    name: 'Irrigation Demand Forecasting',
    category: 'industry',
    featured: false,
    summary: 'Forecast model for irrigation demand using weather and soil telemetry.',
    highlights: ['Time-series forecasting', 'Actionable scheduling outputs'],
    tech: ['XGBoost', 'LightGBM', 'Python'],
    image: media('projects', 'project-13', 'cisnr-lab-2.png'),
  },
  {
    id: 'pest-detection-edge',
    name: 'Edge Pest Detection System',
    category: 'research',
    featured: false,
    summary: 'Edge AI pest detection on low-power devices for greenhouse monitoring.',
    highlights: ['Quantized model inference', 'Low-light robustness tests'],
    tech: ['TensorRT', 'YOLO', 'Jetson Nano'],
    image: media('projects', 'project-13', 'incubator-deployment.png'),
  },
  {
    id: 'leaf-instance-seg',
    name: 'Leaf Instance Segmentation',
    category: 'research',
    featured: false,
    summary: 'Instance-level leaf segmentation for precise area estimation and phenotyping.',
    highlights: ['Mask quality optimization', 'Dense canopy handling'],
    tech: ['Mask R-CNN', 'PyTorch', 'OpenCV'],
    image: media('projects', 'project-14', 'fig-segmentation-pipeline.png'),
  },
  {
    id: 'soil-moisture-fusion',
    name: 'Soil Moisture Fusion Model',
    category: 'industry',
    featured: false,
    summary: 'Fusion model combining vision and sensor data to estimate soil moisture zones.',
    highlights: ['Sensor-vision fusion', 'Field decision support'],
    tech: ['Python', 'Scikit-learn', 'IoT'],
    image: media('projects', 'project-7', 'Deployment-2.png'),
  },
  {
    id: 'crop-yield-regression',
    name: 'Crop Yield Regression Framework',
    category: 'research',
    featured: false,
    summary: 'Regression framework for yield estimation using visual and climate covariates.',
    highlights: ['Feature ablation studies', 'Cross-season validation'],
    tech: ['CatBoost', 'Pandas', 'NumPy'],
  ...
  },
  {
    ...
    category: 'industry',
    featured: false,
    summary: 'CV-based defect detection in manufacturing lines with anomaly-sensitive thresholds.',
    highlights: ['Binary + multi-class defects', 'Production alert integration'],
    tech: ['YOLOv8', 'OpenCV', 'FastAPI'],
    image: media('projects', 'project-4', 'results.png'),
  },
  {
    id: 'document-layout-ai',
    name: 'Document Layout Parsing AI',
    category: 'industry',
    featured: false,
    summary: 'Layout-aware OCR pipeline for extracting structured content from mixed documents.',
    highlights: ['Table and key-value extraction', 'Confidence-based post-processing'],
    tech: ['OCR', 'Transformers', 'Python'],
    image: media('projects', 'project-12', 'sample-2.png'),
  },
  {
    id: 'retail-shelf-monitoring',
    name: 'Retail Shelf Monitoring Vision',
    category: 'industry',
    featured: false,
    summary: 'Shelf monitoring using detection and tracking for stock-out alerts.',
    highlights: ['SKU-level tracking', 'Store dashboard integration'],
    tech: ['DeepSORT', 'YOLO', 'OpenCV'],
    image: media('projects', 'project-13', 'cover.png'),
  },
  {
    id: 'traffic-density-estimation',
    name: 'Traffic Density Estimation',
    category: 'industry',
    featured: false,
    summary: 'Video analytics for real-time traffic density estimation and congestion indicators.',
    highlights: ['Lane-wise counting', 'Congestion scoring'],
    tech: ['Computer Vision', 'Python', 'OpenCV'],
    image: media('projects', 'project-5', 'fig2-dataset-samples.png'),
  },
  {
    id: 'human-pose-safety',
    name: 'Human Pose Safety Monitoring',
    category: 'industry',
    featured: false,
    summary: 'Pose-based safety compliance monitoring in industrial and lab environments.',
    highlights: ['Rule-based posture checks', 'Near real-time inference'],
    tech: ['YOLO-Pose', 'PyTorch', 'OpenCV'],
    image: media('projects', 'project-10', 'cover.png'),
  },
  {
    ...
    category: 'industry',
    featured: false,
    summary: 'Enterprise retrieval-augmented assistant with document ingestion and grounded answers.',
    highlights: ['Hybrid retrieval stack', 'Evaluation-driven prompt tuning'],
    tech: ['LangChain', 'Vector DB', 'LLM APIs'],
    image: media('projects', 'project-12', 'sample-3.png'),
  },
]
